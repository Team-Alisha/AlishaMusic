...
async def gen_thumb(videoid, user_id, theme):
    ...
    try:
        ...
        try:
            text_w, text_h = draw.textsize(f"ALISHA x MUSIC", font=font)
            draw.text(
                ((1280 - text_w) / 2, 30),
                f"ALISHA x MUSIC",
                fill="red",
            ...
            text_w, text_h = draw.textsize(
                f"ALISHA x MUSIC One Of The Most Advanced Telegram Music Bot", font=arial
            )
            draw.text(
                ((1280 - text_w) / 2, 80),
                f"ALISHA x MUSIC One Of The Most Advanced Telegram Music Bot",
                fill="white",
                font=arial,
            )
            if para[0]:
